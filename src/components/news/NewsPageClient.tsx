...
• พิธีเปิด: วันจันทร์ที่ 18 พ.ค. 2569 เวลา 09.00 น. ณ หอประชุมใหญ่`,
  ...
  {
    id: "demo-2",
    title: "เปิดรับสมัคร! การประกวดวาดภาพระบายสีระดับประเทศ Student Art Contest 2026 หัวข้อ 'จินตนาการไร้ขีดจำกัด'",
    excerpt: "โอกาสสำคัญสำหรับนักเรียนผู้มีใจรักศิลปะ ชิงทุนการศึกษารวมกว่า 50,000 บาท พร้อมเกียรติบัตรระดับชาติ ส่งผลงานได้ทั้งภาพวาดและดิจิทัลอาร์ต หมดเขตส่งผลงาน 15 พฤศจิกายนนี้",
    content: `ขอเชิญชวนนักเรียนระดับมัธยมศึกษาตอนต้นและตอนปลาย ส่งผลงานเข้าร่วมการประกวดวาดภาพระดับชาติ "Student Art Contest 2026: Unleash Your Creativity"

รายละเอียดกติกา:
1. คุณสมบัติผู้สมัคร: นักเรียนระดับมัธยมศึกษาตอนต้นและตอนปลาย อายุ 13 - 18 ปี
2. เทคนิค: ไม่จำกัดเทคนิค (สีน้ำ, สีอะคริลิก, ดรอว์อิ้ง หรือ Digital Art)
3. หัวข้อ: "จินตนาการไร้ขีดจำกัด (Imagination in Motion)"
4. รางวัล:
   - รางวัลชนะเลิศ: ทุนการศึกษา 1,000 ดอลลาร์ (35,000 บาท) พร้อมถ้วยรางวัลเกียรติยศ
   - รางวัลรองชนะเลิศอันดับ 1: ทุนการศึกษา 500 ดอลลาร์ พร้อมเกียรติบัตร
   - รางวัลรองชนะเลิศอันดับ 2: ทุนการศึกษา 250 ดอลลาร์ พร้อมอุปกรณ์ศิลปะครบชุด

กำหนดการสำคัญ:
• ส่งผลงานได้ตั้งแต่วันนี้ - 15 พฤศจิกายน 2569
• ประกาศผลทางเว็บไซต์ Art Room และหน้าเพจโรงเรียน
• สนใจสมัครและสอบถามเพิ่มเติมได้ที่ห้องปฏิบัติการศิลปะ (ART ROOM 204)`,
    date: "8 พ.ย. 2569",
    source: "ฝ่ายกิจกรรมศิลปะ",
    category: "การประกวด & รางวัล",
    imageUrl: "/images/news/art-contest-poster.jpg",
    imageType: "poster",
    isFeatured: false,
    tags: ["ประกวดวาดภาพ", "โปสเตอร์ PR (3:4)", "ทุนการศึกษา"]
  },
  {
    id: "demo-3",
...
บรรยากาศเต็มไปด้วยความสนุกสนาน นักเรียนทุกคนได้สร้างสรรค์ผลงานชิ้นเอกของตัวเองกลับบ้าน และนำไปเตรียมจัดแสดงในสัปดาห์ศิลปกรรมต่อไป`,
  ...
  {
    id: "demo-4",
    title: "ประกาศผลการแข่งขันงานศิลปหัตถกรรมนักเรียน ครั้งที่ 72: ตัวแทนโรงเรียนคว้า 3 เหรียญทองระดับชาติ",
    excerpt: "ขอแสดงความยินดีกับตัวแทนนักเรียนโรงเรียนวชิรธรรมสาธิต ที่สามารถคว้ารางวัลชนะเลิศระดับเหรียญทอง การแข่งขันจิตรกรรมภาพไทยประเพณี และการวาดภาพระบายสี สร้างชื่อเสียงให้กับสถานศึกษา",
    content: `กลุ่มสาระการเรียนรู้ศิลปะ ขอแสดงความชื่นชมยินดีกับนักเรียนคนเก่งที่สร้างชื่อเสียงในการแข่งขันศิลปหัตถกรรมนักเรียน ระดับชาติ:

1. นายวีโรจน์ ก่อเกิด - ได้รับรางวัลระดับเหรียญทอง การแข่งขันจิตรกรรมสร้างสรรค์ ม.ปลาย
2. นางสาวอุษณี มหาสุรเดช - ได้รับรางวัลระดับเหรียญทองแดง การแข่งขันวาดภาพระบายสี ม.ปลาย
3. เด็กหญิงรวิภา เลี้ยงวิเชียร - ได้รับรางวัลชนะเลิศระดับเหรียญทอง การเขียนภาพลายรดน้ำ ม.ต้น

ขอขอบคุณคณะครูผู้ฝึกสอนและผู้ปกครองทุกท่านที่ให้การสนับสนุนนักเรียนอย่างเต็มที่`,
    date: "1 พ.ย. 2569",
    source: "งานประชาสัมพันธ์",
    category: "การประกวด & รางวัล",
    imageUrl: "/images/news/hero-exhibition.jpg",
    imageType: "banner",
    isFeatured: false,
    tags: ["ผลงานนักเรียน", "รางวัลระดับชาติ"]
  },
  {
    id: "demo-5",
...
const CATEGORIES = ["ทั้งหมด", "นิทรรศการ", "การประกวด & รางวัล", "เวิร์กช็อป & กิจกรรม", "ประกาศทั่วไป"];
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-red-50/60 via-amber-50/30 to-transparent pt-12 pb-8 border-b border-red-100/50">
        <div className="container mx-auto px-4 sm:px-6 max-w-6xl text-center">
          ...
          <p className="text-gray-600 text-sm sm:text-base max-w-2xl mx-auto font-light leading-relaxed">
            ติดตามข่าวสารนิทรรศการผลงาน กิจกรรมสร้างสรรค์ การประกวดรางวัล และเรื่องราวน่าภาคภูมิใจของนักเรียนกลุ่มสาระการเรียนรู้ศิลปะ โรงเรียนวชิรธรรมสาธิต
          </p>
          ...
          <div className="mt-8 max-w-3xl mx-auto flex flex-col sm:flex-row gap-3 items-center">
            <div className="relative w-full">
              ...
              <input 
                type="text"
                placeholder="ค้นหาข่าวสาร นิทรรศการ กิจกรรม หรือการประกวด..."
                value={searchTerm}
