...
export const metadata: Metadata = {
  ...
  description: "ติดตามข่าวสารนิทรรศการผลงาน กิจกรรมสร้างสรรค์ การประกวดรางวัล และเรื่องราวน่าภาคภูมิใจของนักเรียนกลุ่มสาระการเรียนรู้ศิลปะ โรงเรียนวชิรธรรมสาธิต",
  openGraph: {
    title: "ข่าวสารและประชาสัมพันธ์ | ART ROOM",
    description: "ติดตามข่าวสารนิทรรศการผลงาน กิจกรรมสร้างสรรค์ และการประกวดรางวัล",
