                ...
                {categories.map((cat) => {
                  ...
                  return (
                    <button
                      ...
                      className={`category-btn px-4 py-2 rounded-xl text-xs sm:text-sm font-bold tracking-tight transition-all duration-200 cursor-pointer active:scale-95 hover:-translate-y-1.5 hover:shadow-lg hover:shadow-red-500/15 hover:border-red-400 hover:text-red-600 hover:scale-[1.03] border-2 ${
                        isSelected
                          ? "is-selected bg-red-600 text-white border-red-600 shadow-md shadow-red-600/30 scale-[1.02]"
