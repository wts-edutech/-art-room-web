...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-8 left-0 right-0 w-full z-50 bg-white border-b border-gray-200 shadow-sm transition-all duration-300 pointer-events-auto">
          ...
          {userName ? (
            <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
              {userRole === "teacher" || userRole === "admin" ? (
                <Link 
                  href="/admin" 
                  className="text-xs font-bold text-white bg-red-600 hover:bg-red-700 px-3 py-1.5 rounded-full shadow-xs transition-colors whitespace-nowrap"
                >
                  หลังบ้าน
                </Link>
              ) : null}
            ...
            <Link href="/login" className="flex items-center flex-shrink-0">
              <Button variant="default" className="whitespace-nowrap rounded-xl px-3 sm:px-4 h-9 sm:h-10 shadow-sm shadow-red-500/20 bg-[#ff0f39] hover:bg-[#e00028] text-white text-xs sm:text-sm font-medium transition-all duration-200 border-0 flex items-center gap-1.5 cursor-pointer">
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-1">
          <Link 
            href="/" 
            className={`px-4 py-3 font-medium rounded-xl transition-colors ${pathname === "/" ? "bg-red-50 text-red-600 font-bold" : "text-gray-700 hover:bg-gray-50"}`} 
            onClick={() => setIsMobileMenuOpen(false)}
          >
            หน้าแรก
          </Link>
          ...
          <div className="flex flex-col">
            ...
            <div className={`overflow-hidden transition-all duration-300 ${isMaterialsOpen ? "max-h-48 opacity-100 mt-1" : "max-h-0 opacity-0"}`}>
              <div className="ml-4 flex flex-col border-l-2 border-red-200 pl-2 space-y-1">
                <Link href="/materials" className="px-3 py-2 text-gray-600 hover:text-red-600 font-medium text-sm rounded-lg hover:bg-red-50/50" onClick={() => setIsMobileMenuOpen(false)}>
                  Art Room by Students
                </Link>
                <Link href="/materials/m3" className="px-3 py-2 text-gray-600 hover:text-red-600 font-medium text-sm rounded-lg hover:bg-red-50/50" onClick={() => setIsMobileMenuOpen(false)}>
                  สื่อการสอน (ม.3)
                </Link>
                <Link href="/materials/m4" className="px-3 py-2 text-gray-600 hover:text-red-600 font-medium text-sm rounded-lg hover:bg-red-50/50" onClick={() => setIsMobileMenuOpen(false)}>
                  สื่อการสอน (ม.4)
                </Link>
              </div>
            </div>
          ...
          <Link 
            href="/news" 
            className={`px-4 py-3 font-medium rounded-xl transition-colors ${pathname.startsWith("/news") ? "bg-red-50 text-red-600 font-bold" : "text-gray-700 hover:bg-gray-50"}`} 
            onClick={() => setIsMobileMenuOpen(false)}
          >
            ข่าวสาร
          </Link>
          ...
          <Link 
            href="/ideas" 
            className={`px-4 py-3 font-medium rounded-xl transition-colors ${pathname.startsWith("/ideas") ? "bg-red-50 text-red-600 font-bold" : "text-gray-700 hover:bg-gray-50"}`} 
            onClick={() => setIsMobileMenuOpen(false)}
          >
            แชร์ไอเดีย
          </Link>
          ...
          <div className="flex flex-col">
            ...
            <div className={`overflow-hidden transition-all duration-300 ${isArtworksOpen ? "max-h-32 opacity-100 mt-1" : "max-h-0 opacity-0"}`}>
              <div className="ml-4 flex flex-col border-l-2 border-red-200 pl-2 space-y-1">
                <Link href="/awards" className="px-3 py-2 text-gray-600 hover:text-red-600 font-medium text-sm rounded-lg hover:bg-red-50/50" onClick={() => setIsMobileMenuOpen(false)}>
                  รางวัลที่ได้รับ
                </Link>
                <Link href="/artworks" className="px-3 py-2 text-gray-600 hover:text-red-600 font-medium text-sm rounded-lg hover:bg-red-50/50" onClick={() => setIsMobileMenuOpen(false)}>
                  ผลงานนักเรียน
                </Link>
              </div>
            </div>
          ...
          <div className="flex flex-col">
            ...
            <div className={`overflow-hidden transition-all duration-300 ${isActivitiesOpen ? "max-h-24 opacity-100 mt-1" : "max-h-0 opacity-0"}`}>
              <div className="ml-4 flex flex-col border-l-2 border-red-200 pl-2 space-y-1">
                <Link href="/activities" className="px-3 py-2 text-gray-600 hover:text-red-600 font-medium text-sm rounded-lg hover:bg-red-50/50" onClick={() => setIsMobileMenuOpen(false)}>
                  ปฏิทินกิจกรรม
                </Link>
              </div>
            </div>
          ...
          <div className="flex flex-col">
            ...
            <div className={`overflow-hidden transition-all duration-300 ${isOrgMediaOpen ? "max-h-36 opacity-100 mt-1" : "max-h-0 opacity-0"}`}>
              <div className="ml-4 flex flex-col border-l-2 border-red-200 pl-2 space-y-1">
                <Link href="https://media-center.moe.go.th/Home" target="_blank" rel="noopener noreferrer" className="px-3 py-2 text-gray-600 hover:text-red-600 font-medium text-xs rounded-lg hover:bg-red-50/50" onClick={() => setIsMobileMenuOpen(false)}>
                  ศูนย์รวมการเรียนรู้ (ศธ.)
                </Link>
                <Link href="https://elibrary-bacc.hibrary.me/" target="_blank" rel="noopener noreferrer" className="px-3 py-2 text-gray-600 hover:text-red-600 font-medium text-xs rounded-lg hover:bg-red-50/50" onClick={() => setIsMobileMenuOpen(false)}>
                  ห้องสมุด (BACC)
                </Link>
              </div>
            </div>
          ...
          <Link 
            href="/contact" 
            className={`px-4 py-3 font-medium rounded-xl transition-colors ${pathname === "/contact" ? "bg-red-50 text-red-600 font-bold" : "text-gray-700 hover:bg-gray-50"}`} 
            onClick={() => setIsMobileMenuOpen(false)}
          >
            ติดต่อเรา
          </Link>
        ...
        <div className="p-4 border-t border-gray-100 safe-pb bg-gray-50/50">
          {userName ? (
            ...
            <Link href="/login" onClick={() => setIsMobileMenuOpen(false)}>
              <Button variant="default" className="w-full rounded-xl h-[46px] shadow-sm bg-red-600 hover:bg-red-700 text-white font-bold cursor-pointer text-base">
                เข้าสู่ระบบ
              </Button>
            </Link>
          )}
